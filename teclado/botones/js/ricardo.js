		...
		//location= '/' + numbers.replace(/\s/g,'');
			...
			if ($('.number-area .numbers').text() != "INGRESE SU SERVIDOR")
			{
				...
				switch ($('.number-area .numbers').text()){
					case "1":
					location= 'https://www.medsyscloudone.byethost22.com/medsysweb/login.php';
					break;
					...
					case "3":
					location= 'https://www.mscthree.byethost3.com/medsysweb/login.php';
					break;

					case "4":
					location= 'https://www.medsyscloud004.byethost15.com/medsysweb/login.php';
					break;

					case "5":
					location= 'https://www.medsyscloud005.byethost31.com/medsysweb/login.php';
					break;
					...
					case "7":
					location= 'https://www.medsyscloud007.byethost7.com/medsysweb/login.php';
					break;

					case "8":
					location= 'https://www.medsyscloud008.byethost7.com/medsysweb/login.php';
					break;
					...
					case "10 ":
					location= 'https://www.mscdiez.byethost33.com/medsysweb/login.php';
					break;

					case "11 ":
					location= 'https://medsyscloud010.byethost9.com/medsysweb/login.php';
					break;

					case "12 ":
					location= 'https://www.medsysdoctors001.byethost33.com/medsysweb/';
